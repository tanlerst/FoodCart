/* Line in between status under status tracker component for admin order detail page*/
...
export default function StatusLine({ active }: StatusLineProps) {
    return <div className={`mx-2 h-[2px] flex-1 ${active ? ACTIVE_LINE : INACTIVE_LINE}`} />;
}