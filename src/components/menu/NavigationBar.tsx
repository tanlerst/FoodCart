...
export default function NavigationBar() {
    return (
        ...
        <ul className="flex justify-around">
            <li><NavigationItem imgSrc={home} label="Home" /></li>
            <li><NavigationItem imgSrc={categories} label="Categories" /></li>
            <li><NavigationItem imgSrc={cart} label="Cart" /></li>
            <li><NavigationItem imgSrc={orders} label="Orders" /></li>
            <li><NavigationItem imgSrc={profile} label="Profile" /></li>
        </ul>
        </div>
    );
}   